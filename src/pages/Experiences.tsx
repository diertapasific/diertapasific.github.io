    ...
    items: [
      {
        ...
        period: '2025',
        bullets: [
          'Developed text extraction pipelines with OCR frameworks to transform image-based content into structured digital text.',
          'Automated Windows application interactions to capture and validate on-screen data, reducing reliance on manual input.',
          'Enhanced the CV/Resume Analyzer system with dynamic pop-ups and automated email invitations, improving workflow efficiency.',
        ],
      },
      {
        ...
        period: '2025',
        bullets: [
          'Designed end-to-end ML models addressing real-world business challenges from data preprocessing to evaluation.',
          'Conducted in-depth analysis using SQL and Python to extract actionable insights from large-scale datasets.',
          'Gained hands-on experience with data cleaning, feature engineering, model selection, and performance tuning.',
        ],
      },
      {
        ...
        period: '2024 – 2025',
        bullets: [
          'Developed and deployed secure, scalable APIs supporting frontend applications, improving system reliability by 20%.',
          'Optimized database queries to reduce execution time by up to 30%, delivering faster user response times.',
          'Collaborated with frontend developers, QA, and product managers, reducing post-deployment bugs by 25%.',
        ],
      },
      {
        title: 'Mobile App Developer — Project Based Virtual Internship',
        org: 'Bank Mandiri × Rakamin Academy',
        period: '2023 – 2024',
        bullets: [
          'Built and deployed a cross-platform mobile app prototype for the banking industry compatible on Android and iOS.',
          'Designed accessible, user-friendly interfaces with a focus on seamless customer experience.',
          'Simulated real-world banking use cases, strengthening practical skills in mobile development and teamwork.',
        ],
      },
    ],
  },
